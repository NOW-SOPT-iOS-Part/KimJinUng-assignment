//
//  LoginViewController_ObservablePattern.swift
...
final class LoginViewController_ObservablePattern: UIViewController, AlertShowable {
...
private extension LoginViewController_ObservablePattern {
    func bindViewModel() {
...
private extension LoginViewController_ObservablePattern {
    func addTarget() {
        ...
        idClearButton.addTarget(self, action: #selector(clearButtonDidTap(_:)), for: .touchUpInside)
        pwClearButton.addTarget(self, action: #selector(clearButtonDidTap(_:)), for: .touchUpInside)
        pwShowButton.addTarget(self, action: #selector(pwShowButtonDidTap(_:)), for: .touchUpInside)
        nicknameButton.addTarget(self, action: #selector(nicknameButtonDidTap), for: .touchUpInside)
    }
    
    @objc func textFieldDidChange() {
        viewModel.enableLogin(id: idTextField.text, pw: pwTextField.text)
    }
    
    @objc func loginButtonDidTap() {
        viewModel.checkInput(id: idTextField.text, pw: pwTextField.text)
    }
...
extension LoginViewController_ObservablePattern: MakeNicknameViewDelegate {
...
extension LoginViewController_ObservablePattern: UITextFieldDelegate {
